...
class Game:
    def _draw_window(
        ...
        WIN.blit(LEFT_BEAR, (yellow.x, yellow.y))
        WIN.blit(RIGHT_BEAR, (red.x, red.y))
    ...
    def _yellow_handle_movement(self, keys_pressed, yellow):
    ...
    def _red_handle_movement(self, keys_pressed, red):
    ...
    def _handle_bullets(self, yellow_bullets, red_bullets, yellow, red):
        for bullet in yellow_bullets:
            bullet.x += BULLET_VEL
    ...
    def main(self):
        OPENER.play()
        red = pygame.Rect(700, 300, BEAR_WIDTH, BEAR_HEIGHT)
        yellow = pygame.Rect(100, 300, BEAR_WIDTH, BEAR_HEIGHT)
        ...
        while run:
            ...
            self._yellow_handle_movement(keys_pressed, yellow)
            self._red_handle_movement(keys_pressed, red)

            self._handle_bullets(yellow_bullets, red_bullets, yellow, red)

            self._draw_window(red, yellow, red_bullets, yellow_bullets,
